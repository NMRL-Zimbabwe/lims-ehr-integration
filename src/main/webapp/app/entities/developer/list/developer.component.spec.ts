...
describe('Developer Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'developer', component: DeveloperComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to developerService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDeveloperIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDeveloperIdentifier).toHaveBeenCalledWith(entity);
