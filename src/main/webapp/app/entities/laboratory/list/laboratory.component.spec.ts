...
describe('Laboratory Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'laboratory', component: LaboratoryComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(LaboratoryComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to laboratoryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLaboratoryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLaboratoryIdentifier).toHaveBeenCalledWith(entity);
